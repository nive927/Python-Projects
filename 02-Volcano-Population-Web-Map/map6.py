...
for lt, ln, el, name in zip(latitude, longitude, elevation, vname):
    ...
    fg.add_child(folium.CircleMarker(location=[lt, ln], radius=6, popup=folium.Popup(iframe), fill_color=color_producer(el), color='black', fill=True, fill_opacity=0.9))
